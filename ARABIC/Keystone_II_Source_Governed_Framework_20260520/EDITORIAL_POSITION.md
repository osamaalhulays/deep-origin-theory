...
`نظرية الأصل العميق: A Source-Governed Framework for Curvature Response and Cosmological Dynamics`
...
`The Governing Bridge Law` remains part of the identity of the theory, but it should appear as an internal formulation name, section title, or principle inside the manuscript.

It should not be the main outward-facing title of the deposit.

## Main deposit contents

The main paper should contain:

- نظرية الأصل العميق as one theory
